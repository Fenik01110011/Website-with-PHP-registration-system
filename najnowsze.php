...
<head>
	...
	<link rel="stylesheet" href="css/najnowsze.css" type="text/css" />
...
<body>
	...
	<header>
		<img id="main_img" src="img/used/kontynenty-liczby.jpg" alt="internet siec media">
		<div id="headerText">
		...
		<nav id="topnav">
			<div id="menu">
				<a href="aktualnosci"><div>Aktualności</div></a><a href="najnowsze-posty"><div style="background-color: #0b63a1;">Najnowsze posty</div></a><a href="kategorie"><div>Kategorie</div></a><a href="regulamin"><div>Regulamin</div></a><a href="dodaj-post"><div style="color: #45d142;">Dodaj post</div></a>
			</div>
			<div></div>
			<?php 
