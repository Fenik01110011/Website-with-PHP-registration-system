...
<head>
	...
	<link rel="stylesheet" href="css/kategori.css" type="text/css" />
...
<body>
	...
	<header>
		<img id="main_img" src="img/used/tablet-garnitur.png" alt="internet siec media">
		<div id="headerText">
			<h1>Kategorie</h1>
		</div>
		...
		<nav id="topnav">
			<div id="menu">
				<a href="aktualnosci"><div>Aktualności</div></a><a href="najnowsze-posty"><div>Najnowsze posty</div></a><a href="kategorie"><div style="background-color: #0b63a1;">Kategorie</div></a><a href="regulamin"><div>Regulamin</div></a><a href="dodaj-post"><div style="color: #45d142;">Dodaj post</div></a>
			</div>
			<div></div>
			<?php 
